...
function initChat(){
  ...
  if (llmToggle) llmToggle.checked = !!state.config.useLLM;
  ...
  if (llmToggle) llmToggle.addEventListener("change", () => { state.config.useLLM = !!llmToggle.checked; saveConfig(state.config); });
